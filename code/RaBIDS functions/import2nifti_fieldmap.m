        ...
        case 'phasediff'
            ...
            try
               ...
               % anonymize
                ...
                % TotalReadoutTime is not mandatory for BIDS, remove because metadata information may not be informative (wrong units) and can cause errors in fmriprep
                try jsonf = rmfield(jsonf,{'TotalReadoutTime'}); end
