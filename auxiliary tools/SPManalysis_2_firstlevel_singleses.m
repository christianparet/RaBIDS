...
% 2021/09/08: now ready to take subject file structures without intermediate session directory level (e.g. dataset --> sub-01 --> func, anat, etc.). CAVE: not tested for datasets with intermediate session directory level!
